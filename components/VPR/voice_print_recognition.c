    ...
    switch(rst)
    {
        case vpr_reg_successed:
            mprintf("voice print registe successed:%x\n", rec_index);
                ...
                if(gVPRCloudCmdProtocol[rec_index][VPR_REG_SUCCESS].cloudCmdProtocol.play_type == 1)  //主动播报
        ...
        case vpr_reg_failed:
            ...
            #if CLOUD_CFG_PLAY_EN
                if(gVPRCloudCmdProtocol[rec_index][VPR_REG_ERR].cloudCmdProtocol.play_type == 1)  //主动播报
        ...
        case vpr_rec_successed:
            ...
            #if CLOUD_CFG_PLAY_EN
                if(gVPRCloudCmdProtocol[rec_index][VPR_ASR_SUCCESS].cloudCmdProtocol.play_type == 1)  //主动播报
        ...
        case vpr_rec_failed:
            ...
            g_voice_print_rec_index = -1;
            #if CLOUD_CFG_PLAY_EN
                if(gVPRCloudCmdProtocol[rec_index][VPR_ASR_ERR].cloudCmdProtocol.play_type == 1)  //主动播报
