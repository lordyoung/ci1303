...
{
    while(len--)
        UartPollingSenddata((UART_TypeDef *)UART_PROTOCOL_NUMBER, *pbuf++);
}
...
void vpr_cloud_cmd_init_call(void)
{
    ...
    ///tag-insert-voiceprint-protocol-pos-20
        ...
        //     {VPR_ASR_ERR,     {1, "\xA5\xFA\xe0\x81\xB\x60\x2B\xFB", 8, 0}},         //识别失败
        // },
        // {
        //     {VPR_REG_SUCCESS, {10004, "\xA5\xFA\xe0\x81\xB\x60\x2B\xFB", 8, 0}},     //注册成功
        //     {VPR_REG_ERR,     {10005, "\xA5\xFA\xe0\x81\xB\x60\x2B\xFB", 8, 0}},     //注册失败
...
void vgr_cloud_cmd_init_call(void)
{
    ...
    ///tag-insert-gender-vp-protocol-pos-21
...
void cry_cloud_cmd_init_call(void)
{
    ...
    ///tag-insert-cry-detect-protocol-pos-22
...
void snore_cloud_cmd_init_call(void)
{
    ...
    ///tag-insert-snore-detect-protocol-pos-23
...
void doa_cloud_cmd_init_call(void)
{
    ...
    ///tag-insert-doa-angle-protocol-pos-24
