...
// #define CI_CHIP_TYPE                1303     //flash:4MB,QFN40 双mic算法+外部codec 7243e用该板级
...
//录音+flash存储+播放测试
#define RECORD_PLAY_BY_FLASH_ENABLE                   0                         //录音播放demo-仅提供参考代码，可以根据录音需求修改cias_record_demo.c
#if RECORD_PLAY_BY_FLASH_ENABLE
#define RECORD_SAVE_FLASH_START_ADDR                  0X300000                 //录音flash存储起始地址-3M-用户根据自己芯片大小调整
#define RECORD_SAVE_FLASH_SIZE                        1024*512                 //录音flash存储大小-128KB
#endif 
...
#define UART_PROTOCOL_NUMBER           HAL_UART1_BASE      //语音模块协议使用的串口，请勿与log共用同一个串口。
...
#define CLOUD_CFG_UART_PORT          HAL_UART1_BASE // HAL_UART0_BASE ~ HAL_UART2_BASE，请勿与log共用同一个串口
...
#define UART_PROTOCOL_BAUDRATE         UART_BaudRate9600         //TTS默认波特率115200
...
#define EXIT_WAKEUP_TIME                15000    //退出唤醒超时时间,单位毫秒。超过此配置指定的时间长度内没有识别到任何命令词，就会切换到只监听唤词状态。
...
#error "use TTS, SIMPLE_AUDIO_PLAYER_ENABLE MUSET SET 0!\n"
#endif
#endif
...
#define SPK_DTW_THRESHOLD_X1000     290
#define SPK_CEP_LIFTER      22      /* sinusoidal cepstral liftering order */
