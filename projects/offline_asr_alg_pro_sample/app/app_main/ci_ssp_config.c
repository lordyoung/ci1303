...
{
	.alg_enable = true,
	.iis_out_enable = USE_IIS1_OUT_PRE_RSLT_AUDIO || RECORD_PLAY_BY_FLASH_ENABLE,			 //用于采音。
...
const aec_config_t aec_config =
{
	...
	.alc_off_codec_adc_gain_mic = 20,    //主mic左通道pga增益
    .alc_off_codec_adc_gain_ref = 0      //主mic右通道(参考信号)
};
